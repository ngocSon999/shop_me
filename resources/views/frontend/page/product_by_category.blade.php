                ...
                <div class="row g-4">
                    <div class="text-start">
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            <li class="nav-item">
                                <a class="d-flex m-2 py-2 bg-light rounded-pill" href="{{ route('web.index') }}"
                            ...
                            @foreach($categories as $category)
                                <li class="nav-item">
                                    <a class="d-flex py-2 m-2 bg-light rounded-pill product-category {{ $category->slug === $slug ? 'active' : '' }}"

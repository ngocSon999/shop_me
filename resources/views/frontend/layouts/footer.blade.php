        ...
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p class="mb-4">{{ getSetting('description_footer') ?? '' }}</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
